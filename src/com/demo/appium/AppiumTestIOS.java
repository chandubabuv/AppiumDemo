...
public class AppiumTestIOS {
	...
	public void setUp() throws MalformedURLException {
		...
		caps.setCapability("app", "/Users/Downloads/ios-uicatalog-master/build/Release-iphonesimulator/UICatalog.app");
		driver = new IOSDriver(new URL("http://127.0.0.1:4725/wd/hub"), caps);
	}

	@Test
	public void testiOS() throws InterruptedException, IOException {
		driver.findElement(By.xpath("//UIAApplicationIAWindow[1]/UIATableView[1]/UIATableCell[1]/UIAStaticText[1]"))
				.click();
		driver.findElement(By.xpath("//UIAApplicationIAWindow[1]/UIATableView[1]/UIATableCell[1]/UIAStaticText[1]"))
				.click();
